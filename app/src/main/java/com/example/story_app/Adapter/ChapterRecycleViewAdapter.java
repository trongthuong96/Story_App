...
public class ChapterRecycleViewAdapter extends RecyclerView.Adapter<ChapterRecycleViewAdapter.ChapterViewHolder> {
    ...
    public ChapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chapter_acitivity_chapter_detail, parent, false);
    ...
    public void onBindViewHolder(@NonNull ChapterViewHolder holder, int position) {
        ...
        holder.txtChapterNameNumber.setText("Chương "+model.getNumberChapter()+": "+model.getName());
